...
class Student extends Model
{
    ...
    protected $fillable = [
        'id_number', 'name', 'phone', 'email', 'password','birthday', 'gender_id', 'religion_id', 'blood_group_id', 'address', 'photo', 'parent_id', 'dormitory_id', 'transport_id', 'agent_banking_no', 'status'
    ];
